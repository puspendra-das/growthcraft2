        ...
        <Card className="border-border/50">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea defaultValue="Acme Technologies is a leading software company specializing in enterprise solutions and digital transformation." rows={3} />
            </div>
          </CardContent>
        </Card>

        <Card className="border-border/50">
          <CardHeader><CardTitle className="text-lg">Hiring Preferences</CardTitle></CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2"><Label>Typical Roles</Label><Input defaultValue="Software Developer, Data Analyst, DevOps" /></div>
              <div className="space-y-2"><Label>Hiring Frequency</Label><Input defaultValue="Quarterly" /></div>
            </div>
            <div className="space-y-2">
              <Label>Additional Notes</Label>
              <Textarea defaultValue="We prefer candidates with project experience and good communication skills." rows={2} />
            </div>
          </CardContent>
        </Card>
