import { BookOpen, Clock, Award, TrendingUp, Play, CheckCircle2, Star } from "lucide-react";
...
const enrolledCourses = [
  { id: 1, title: "Full Stack Web Development", progress: 68, totalLessons: 42, completed: 28, category: "Web Dev", image: "🌐" },
  { id: 2, title: "Data Science with Python", progress: 35, totalLessons: 36, completed: 13, category: "Data Science", image: "📊" },
  { id: 3, title: "React & Next.js Masterclass", progress: 90, totalLessons: 30, completed: 27, category: "Frontend", image: "⚛️" },
];

const upcomingDeadlines = [
  { title: "Python Assignment 3", course: "Data Science with Python", due: "Apr 2, 2026", type: "Assignment" },
  { title: "React Project Submission", course: "React & Next.js Masterclass", due: "Apr 5, 2026", type: "Project" },
  { title: "SQL Quiz", course: "Full Stack Web Development", due: "Apr 8, 2026", type: "Quiz" },
];
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm md:text-base">Continue where you left off</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        {[
          ...
          { label: "Avg. Score", value: "82%", icon: TrendingUp, color: "text-green-500" },
        ].map((stat) => (
          ...
          {enrolledCourses.map((course) => (
            <Card key={course.id} className="border-border/50 hover:shadow-md transition-shadow">
              <CardContent className="p-5">
                ...
                <Button size="sm" className="w-full mt-4" variant={course.progress > 80 ? "default" : "outline"}>
                  <Play className="h-3.5 w-3.5 mr-1.5" />
                  {course.progress > 80 ? "Almost Done!" : "Continue"}
                </Button>
              </CardContent>
            </Card>
          ))}
